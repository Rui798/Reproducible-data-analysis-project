...
Pos : Position (Links to an external site.)   (PG = point guard, SG = shooting guard, SF = small forward, PF = power forward, C = center) 
...
2P% : FG% on 2-Pt FGAs
eFG% : Effective Field Goal Percentage (Links to an external site.)
FT : Free Throws
